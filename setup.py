...
shutil.copy(
    "_metadata.py",
    os.path.join("pytket", "extensions", "pysimplex", "_metadata.py"),
)
...
setup(
    ...
    description="Extension for pytket, providing access to the pysimplex Clifford "
    "simulator",
    ...
    install_requires=["pytket == 1.15.0rc1",, "pysimplex ~= 1.4"],
    classifiers=[
        "Environment :: Console",
